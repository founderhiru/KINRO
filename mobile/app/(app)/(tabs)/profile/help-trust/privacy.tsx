...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "See the Security section for more detail.",
    ],
  },
  {
  ...
  return (
    <Screen>
      <ScrollView contentContainerStyle={styles.scroll}>
        <Text style={[typography.title, styles.title]}>Privacy Policy</Text>
        <Text style={[typography.caption, styles.effectiveDate]}>
...
const styles = StyleSheet.create({
  ...
  effectiveDate: { marginBottom: spacing.lg },
