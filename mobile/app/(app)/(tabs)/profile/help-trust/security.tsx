...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    paragraphs: [
      "Every request that reads or changes your data is checked against your signed-in session on our servers — we never trust an identifier sent from the app itself to decide whose data to show or change. Dog profiles, health records, and messages are only readable and editable by their owner or, for messages, the two matched participants.",
    ],
  },
  {
  ...
  return (
    <Screen>
      <ScrollView contentContainerStyle={styles.scroll}>
        <Text style={[typography.title, styles.title]}>Security</Text>
        <Text style={[typography.bodyMuted, styles.intro]}>
          Your trust matters.
        </Text>
        {SECTIONS.map((section) => (
          <View key={section.heading} style={styles.section}>
            <Text style={[typography.sectionTitle, styles.heading]}>
              {section.heading}
            </Text>
